...
import com.kisconsult.ismummy.virtualdoctor.Fragment.PatientHome;
...
public class Patient extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PatientHome frag = new PatientHome();
        ...
        navigationView.inflateMenu(R.menu.drawer_patient_menu);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            PatientHome fragment = new PatientHome();
